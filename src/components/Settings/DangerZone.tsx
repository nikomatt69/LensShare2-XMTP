...
const DangerZone = () => {
    ...
    return (
        <div className="p-5 bg-gray-50 dark:bg-gray-800  border border-gray-100 rounded-lg dark:divide-gray-900 dark:bg-theme">
            ...
            <div className="flex flex-col space-y-5">
                ...
                <div className="text-sm lt-text-gray-500 divide-y dark:divide-gray-700">
                    <p className="pb-3">You cannot restore your {APP_NAME} account if it was accidentally or wrongfully deleted.</p>
