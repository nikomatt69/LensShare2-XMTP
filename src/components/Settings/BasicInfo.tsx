...
import sanitizeIpfsUrl from '@/utils/functions/sanitizeIpfsUrl2'
...
const formSchema = z.object({
  ...
  website: z.union([
    z
      .string()
      .url({ message: 'Enter valid website URL (eg. https://lensshare.xyz)' }),
    z.string().max(0)
  ])
})
...
const BasicInfo = ({ profile }: Props) => {
  ...
  return (
    <div className='bg-gray-50 dark:bg-gray-800  border border-gray-100 p-4 rounded-xl'>
      <Form
        form={form}
