...
const MirrorButton: FC<Props> = ({publication}) => {
    ...
    return (
       <div className="flex gap-6">
        ...
        {alreadyMirrored ? (
         <div className="flex items-center drop-shadow-lg border border-[#57B8FF] md:border-none bg-blue-700 rounded-full p-2 md:p-3">
         <ArrowsRightLeftIcon className="w-4 h-4 text-[#57B8FF] font-bold" />
          </div>
        ) : (
        <div 
