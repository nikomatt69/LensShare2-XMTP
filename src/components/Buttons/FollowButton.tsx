    ...
    <>
      <div >
        <button onClick={createFollow} disabled={isLoading} 
           className='active:bg-violet-600 py-1 px-3 drop-shadow-xl rounded-full text-sm mt-2 border hover:text-[#000000] hover:bg-[#57B8FF] transition cursor-pointer bg-[#57B8FF] text-[#000000] font-semibold'>
          Follow
        </button>
      </div>
    </>
