  ...
  return (
    <div>
          <div className="mx-5 mt-5">
            ...
            <select
              className="w-full bg-white rounded-xl border border-gray-300 outline-none dark:bg-gray-800 disabled:bg-gray-500 disabled:bg-opacity-20 disabled:opacity-60 /80 focus:border-brand-500 focus:ring-brand-400"
              onChange={(e) => {
