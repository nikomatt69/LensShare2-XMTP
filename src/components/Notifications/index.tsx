        ...
        <>
            ...
            <div className='flex flex-col max-w-5xl mx-auto'>
                <div className='my-6 flex justify-center'>
                    <div className="flex border-2 border-black rounded-full py-2 px-2 items-center space-x-2">
                        <button
                ...
                <div className='flex flex-col relative w-full border bg-gray-50 border-gray-200 dark:bg-gray-800  md:rounded-lg'>
