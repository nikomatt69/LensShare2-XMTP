...
const Notifications: FC = () => {
    ...
    return (
        <>
            ...
            >
                <div
                    className="mt-1.5 w-96 -mr-20 divide-y focus-visible:outline-none focus:outline-none focus:ring-0 dropdown-shadow divide-gray-100  overflow-hidden border border-gray-100 rounded-xl bg-white"
                >
